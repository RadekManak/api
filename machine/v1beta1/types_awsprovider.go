...
type MetadataServiceOptions struct {
	...
	// When omitted, the AWS default will be used. As of this writing the AWS default is Enabled.
	...
	// When omitted, the AWS default will be used. As of this writing the AWS default is 1 for IMDSv1 and 2 for IMDSv2.
	// +kubebuilder:validation:Minimum=1
	...
	// When omitted, the AWS default will be used. As of this writing the AWS default is Disabled.
