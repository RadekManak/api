...
var map_MetadataServiceOptions = map[string]string{
	...
	"httpEndpoint":            "httpEndpoint enables or disables the HTTP metadata endpoint on your instances. Valid values are \"Enabled\" and \"Disabled\". When set to Enabled, the HTTP metadata endpoint is accessible. When set to Disabled, you cannot access your instance metadata. When omitted, the AWS default will be used. As of this writing the AWS default is Enabled.",
	"httpPutResponseHopLimit": "httpPutResponseHopLimit is the maximum number of hops that the metadata token can travel. Valid values range from 1 to 64. When omitted, the AWS default will be used. As of this writing the AWS default is 1 for IMDSv1 and 2 for IMDSv2.",
